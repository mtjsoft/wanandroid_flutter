...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case HotKeyEntity:
			return hotKeyEntityFromJson(data as HotKeyEntity, json) as T;			case UserInfoEntity:
			return userInfoEntityFromJson(data as UserInfoEntity, json) as T;			case ArticleListEntity:
			return articleListEntityFromJson(data as ArticleListEntity, json) as T;			case ArticleListData:
			return articleListDataFromJson(data as ArticleListData, json) as T;			case ChaptersEntity:
			return chaptersEntityFromJson(data as ChaptersEntity, json) as T;			case FriendLinkEntity:
			return friendLinkEntityFromJson(data as FriendLinkEntity, json) as T;			case BannerTestEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case HotKeyEntity:
			return hotKeyEntityToJson(data as HotKeyEntity);			case UserInfoEntity:
			return userInfoEntityToJson(data as UserInfoEntity);			case ArticleListEntity:
			return articleListEntityToJson(data as ArticleListEntity);			case ArticleListData:
			return articleListDataToJson(data as ArticleListData);			case ChaptersEntity:
			return chaptersEntityToJson(data as ChaptersEntity);			case FriendLinkEntity:
			return friendLinkEntityToJson(data as FriendLinkEntity);			case BannerTestEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'HotKeyEntity':
			return HotKeyEntity().fromJson(json);			case 'UserInfoEntity':
			return UserInfoEntity().fromJson(json);			case 'ArticleListEntity':
			return ArticleListEntity().fromJson(json);			case 'ArticleListData':
			return ArticleListData().fromJson(json);			case 'ChaptersEntity':
			return ChaptersEntity().fromJson(json);			case 'FriendLinkEntity':
			return FriendLinkEntity().fromJson(json);			case 'BannerTestEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'HotKeyEntity':
			return List<HotKeyEntity>();			case 'UserInfoEntity':
			return List<UserInfoEntity>();			case 'ArticleListEntity':
			return List<ArticleListEntity>();			case 'ArticleListData':
			return List<ArticleListData>();			case 'ChaptersEntity':
			return List<ChaptersEntity>();			case 'FriendLinkEntity':
			return List<FriendLinkEntity>();			case 'BannerTestEntity':
